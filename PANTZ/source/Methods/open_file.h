 ...
 *
 * This file implements the general open file methods*/

// This file is supposed to be included by Methods.h
#ifndef Methods_Loading_Status
#error METHODS::open_file.h must be included by Methods.h
#endif

// Implement the method for writing to files
void METHODS::open_file (const string& fileName, ofstream& output, 
...
void METHODS::open_file (const string& fileName, ifstream& input) {
